...
const Categories = () => {
  return (
    ...
    <h1 className=" md:text-4xl text-2xl font-semibold text-center">Popular Categories </h1>
      ...
      <div className="py-5 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 md:gap-5 gap-3 font-jakarta">
        {
            productCategories.map((category,index)=>{
                return<Link to={`/products?category=${category.name}`}>
        ...
        <h1 className=" font-bold   text-primary_color text-center">{category.name}</h1>
