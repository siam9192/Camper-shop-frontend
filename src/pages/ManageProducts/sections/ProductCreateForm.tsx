...
const ProductCreateForm = () => {
  ...
  const submit = async (data: any) => {
    ...
    data.images = (await uploadedImages).map(
        ...
        <div className="flex flex-col bg-white pointer-events-auto max-w-full max-h-full h-full dark:bg-neutral-800">
          <div className="flex justify-between items-center py-3 px-4 border-b dark:border-neutral-700">
            ...
            <button
              ...
              onClick={() => closeModal('hs-full-screen-modal-1')}
            >
                ...
                <div>
                  ...
                  >
                    ...
                    <div className="text-end">
                      ...
                      <button
                        type="submit"
                        className=" px-10 py-2 bg-secondary_color text-white uppercase"
                      >
