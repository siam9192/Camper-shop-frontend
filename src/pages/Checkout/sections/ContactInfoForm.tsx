...
export const ContactInfoForm = () => {
  ...
  const handleCheckOut = (value: any) => {
    ...
    Promise.all(orders.map((order) => postOrder(order))).then((values) => {
    ...
    <form action="" onSubmit={handleSubmit(handleCheckOut)} className="my-5">
      ...
      <div className="space-y-4 py-3">
        <input
          ...
          {...register('email')}
          required
          className=" w-full text-black placeholder:text-gray-600 placeholder:font-semibold p-2 border border-gray-200 focus:border-gray-900 rounded-md "
          placeholder="Email"
        />
        <input
          type="text"
      ...
      <button
        ...
        className="w-full my-5 py-2 bg-button_color text-white font-semibold"
      >
